'''
Gradient-weighted Class Activation Mapping of CNN images (GradCAM)
+ Guided Backpropogation (GB)
+ GradCAM w/ GB

Pulls image from 'block5_conv3' layer prior to pulling 1x4096 feature vector, creates heatmap and computes saliency for 
'''
